...
from rotkehlchen.chain.monero.typing import MoneroWalletRpc
...
class MoneroManager():
    def __init__(
            self,
            wallet_rpc_endpoint: str,
            msg_aggregator: MessagesAggregator,
            wallets: [MoneroWalletRpc],
            rpc_timeout: int = DEFAULT_XMR_RPC_TIMEOUT,
    ) -> None:
        log.debug(
            f'Initializing Monero Manager with local wallet rpc endpoint: {wallet_rpc_endpoint}')
